...
updateDayViewAdmin: function (params) {
        console.log('Transaction | updateDayViewAdmin | then | params', params);
        ...
        return Parse.Promise.when([
            ...
            return new Parse.Query('TransactionDayView')
                ...
                console.log('Transaction | updateDayViewAdmin | then | row',row)
                ...
                return row.save().then(function () {
                    console.log('Transaction | updateDayViewAdmin | then | save | row',row);
                    return row;
                });
            });
        });
